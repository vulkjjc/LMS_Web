        ...
        <div class="col-md-9 col-lg-12 col-xl-10">
            <div class="card shadow-lg o-hidden border-0 my-5">
                <div class="card-body p-0">
                  <div class="row">
                        <div class="flex-grow-1 bg-password-image"><div class="flex-grow-1 bg-login-image"><div style="border: double black; width:250px;height: 250px;margin-left: 30%;margin-top: 20%;"><div class="py-5 px-5 ml-4 mt-3"><i class="fas fa-user fa-7x text-dark"></i></div></div></div></div>
                    <div class="col-lg-6">
                      <div class="p-5">
                                ...
                                <form class="user" id="login-form" method="post">
                                  ...
                                  <div class="form-group"><input class="form-control form-control-user" type="password" id="exampleInputPassword" placeholder="Password" name="password" required/></div>
                                    ...
                                    <hr/><a class="btn btn-danger btn-block text-white btn-user" role="button" href="Forgot.php">  Forgot Password?</a>
                                    <hr/>
						  		</form>
                            </div>
                        </div>
